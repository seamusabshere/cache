...
class TestDefaultStorage < Test::Unit::TestCase
  ...
  def test_query
    assert_equal ActiveSupport::Cache::MemoryStore, @cache.instance_variable_get(:@metal).class
  end
  
  def test_default
    c = Cache.new
    assert_equal ActiveSupport::Cache::MemoryStore, c.instance_variable_get(:@metal).class
  end
